...
## 結果（best @epoch 12）
- accuracy=0.7479 / macro_f1=0.4669
- edit=14.40 / seg_f1@10/25/50=0.17/0.14/0.11

## 構成
- seed=456 epochs=50 lr=0.0005 in_dim=2063(=2048+15) tool_source=pred stages=2 layers=8 f_maps=64
