...
## 結果（best @epoch 26・val）
### plain decode
- acc=0.9426 / macro_f1=0.7994
- edit=43.92 / seg_f1@10/25/50=0.552/0.542/0.502
### sticky decode（τ=0.5）
- acc=0.9320 / macro_f1=0.7698
- edit=52.22 / seg_f1@10/25/50=0.619/0.607/0.541

## 構成
- seed=456 epochs=50 lr=0.0005 d_model=256 tok_dim=128 pres_dim=64 stages=2 layers=8
