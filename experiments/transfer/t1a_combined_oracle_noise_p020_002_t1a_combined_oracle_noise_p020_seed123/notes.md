...
## 結果（best @epoch 17）
- accuracy=0.9465 / macro_f1=0.8043
- edit=31.85 / seg_f1@10/25/50=0.43/0.43/0.38

## 構成
- seed=123 epochs=50 lr=0.0005 in_dim=5903(=2048+3840) stages=2 layers=8 f_maps=64
