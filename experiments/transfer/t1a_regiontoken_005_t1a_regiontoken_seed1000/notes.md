...
## 結果（best @epoch 18）
- accuracy=0.9492 / macro_f1=0.8065
- edit=34.72 / seg_f1@10/25/50=0.45/0.44/0.42

## 構成
- seed=1000 epochs=50 lr=0.0005 in_dim=5888(=2048+3840) stages=2 layers=8 f_maps=64
