...
## 結果（best @epoch 38）
- accuracy=0.9010 / macro_f1=0.7130
- edit=38.81 / seg_f1@10/25/50=0.42/0.39/0.32

## 構成
- seed=456 epochs=50 lr=0.0005 in_dim=2063(=2048+15) tool_source=oracle stages=2 layers=8 f_maps=64
