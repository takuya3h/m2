...
## 結果（best @epoch 43）
- accuracy=0.9564 / macro_f1=0.8199
- edit=57.54 / seg_f1@10/25/50=0.64/0.63/0.61

## 構成
- seed=42 epochs=50 lr=0.0005 in_dim=2078(=2048+30) tool_source=both stages=2 layers=8 f_maps=64
