...
## 結果（best @epoch 24）
- accuracy=0.9472 / macro_f1=0.8066
- edit=34.70 / seg_f1@10/25/50=0.44/0.43/0.40

## 構成
- seed=789 epochs=50 lr=0.0005 in_dim=5888(=2048+3840) stages=3 layers=10 f_maps=96
