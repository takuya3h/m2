...
## 結果（best @epoch 37）
- accuracy=0.7571 / macro_f1=0.4846
- edit=14.78 / seg_f1@10/25/50=0.18/0.14/0.11

## 構成
- seed=123 epochs=50 lr=0.0005 in_dim=2078(=2048+30) tool_source=both stages=2 layers=8 f_maps=64
