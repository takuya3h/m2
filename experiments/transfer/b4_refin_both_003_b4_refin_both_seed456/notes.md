...
## 結果（best @epoch 12）
- accuracy=0.7624 / macro_f1=0.5046
- edit=15.96 / seg_f1@10/25/50=0.19/0.15/0.12

## 構成
- seed=456 epochs=50 lr=0.0005 in_dim=2078(=2048+30) tool_source=both stages=2 layers=8 f_maps=64
