...
手特徴 `geom`（16-d, source=oracle）を GAP(2048) に入力連結 → 素 causal TeCNO。①は勾配を交差させず信号のみ渡す。online/causal。


## 結果（best @epoch 45）
- accuracy=0.9122 / macro_f1=0.7530
- edit=38.62 / seg_f1@10/25/50=0.44/0.44/0.36

## 構成
- seed=456 epochs=50 lr=0.0005 in_dim=2064 stages=2 layers=8 f_maps=64
