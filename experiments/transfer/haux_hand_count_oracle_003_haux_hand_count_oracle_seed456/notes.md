...
手特徴 `count`（4-d, source=oracle）を GAP(2048) に入力連結 → 素 causal TeCNO。①は勾配を交差させず信号のみ渡す。online/causal。


## 結果（best @epoch 33）
- accuracy=0.8950 / macro_f1=0.6690
- edit=41.92 / seg_f1@10/25/50=0.52/0.48/0.43

## 構成
- seed=456 epochs=50 lr=0.0005 in_dim=2052 stages=2 layers=8 f_maps=64
