...
## 結果（best @epoch 10）
- accuracy=0.7406 / macro_f1=0.4648
- edit=14.96 / seg_f1@10/25/50=0.17/0.13/0.10

## 構成
- seed=42 epochs=50 lr=0.0005 in_dim=2063(=2048+15) tool_source=oracle stages=2 layers=8 f_maps=64
