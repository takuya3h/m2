...
## 結果（best @epoch 44）
- accuracy=0.9485 / macro_f1=0.8139
- edit=30.81 / seg_f1@10/25/50=0.40/0.39/0.36

## 構成
- seed=456 epochs=50 lr=0.0005 in_dim=5888(=2048+3840) stages=3 layers=10 f_maps=96
