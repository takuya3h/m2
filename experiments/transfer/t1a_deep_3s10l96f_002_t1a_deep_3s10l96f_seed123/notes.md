...
## 結果（best @epoch 17）
- accuracy=0.9485 / macro_f1=0.8141
- edit=36.30 / seg_f1@10/25/50=0.47/0.46/0.46

## 構成
- seed=123 epochs=50 lr=0.0005 in_dim=5888(=2048+3840) stages=3 layers=10 f_maps=96
