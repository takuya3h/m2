...
- temporal_feature = **movavg**（k=3; movavg=移動平均 / delta=差分 / window=stack×k / none=生）
...
## 結果（best @epoch 43）
- accuracy=0.9426 / macro_f1=0.7888
- edit=44.13 / seg_f1@10/25/50=0.53/0.53/0.46

## 構成
- seed=456 epochs=50 lr=0.0005 in_dim=5888 stages=2 layers=8 f_maps=64 region_only=False add_toolpresence=False
