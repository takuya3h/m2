...
## 結果（best @epoch 19）
- accuracy=0.7386 / macro_f1=0.4619
- edit=13.71 / seg_f1@10/25/50=0.17/0.14/0.11

## 構成
- seed=123 epochs=50 lr=0.0005 in_dim=2063(=2048+15) tool_source=pred stages=2 layers=8 f_maps=64
