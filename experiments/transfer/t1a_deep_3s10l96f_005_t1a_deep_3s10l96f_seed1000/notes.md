...
## 結果（best @epoch 21）
- accuracy=0.9479 / macro_f1=0.8081
- edit=32.59 / seg_f1@10/25/50=0.44/0.42/0.40

## 構成
- seed=1000 epochs=50 lr=0.0005 in_dim=5888(=2048+3840) stages=3 layers=10 f_maps=96
