...
## 結果（best @epoch 42）
- accuracy=0.9380 / macro_f1=0.7965
- edit=40.38 / seg_f1@10/25/50=0.47/0.47/0.45

## 構成
- seed=42 epochs=50 lr=0.0005 in_dim=2063(=2048+15) tool_source=pred stages=2 layers=8 f_maps=64
