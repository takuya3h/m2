...
## 結果（best @epoch 29・val）
### plain decode（per-frame argmax = T1a base と同一推論）
- accuracy=0.9479 / macro_f1=0.8111
- edit=35.24 / seg_f1@10/25/50=0.451/0.440/0.429
### sticky decode（因果 boundary-gated・τ=0.5）
- accuracy=0.8238 / macro_f1=0.7217
- edit=42.52 / seg_f1@10/25/50=0.371/0.357/0.327

## 構成
- seed=456 epochs=50 lr=0.0005 in_dim=5888(=2048+3840) stages=2 layers=8 f_maps=64
