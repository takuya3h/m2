...
## 結果（best @epoch 45）
- accuracy=0.9617 / macro_f1=0.8275
- edit=55.36 / seg_f1@10/25/50=0.64/0.64/0.63

## 構成
- seed=123 epochs=50 lr=0.0005 in_dim=2063(=2048+15) tool_source=oracle stages=2 layers=8 f_maps=64
