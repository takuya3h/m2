...
## 結果（best @epoch 44）
- accuracy=0.8403 / macro_f1=0.5929
- edit=22.49 / seg_f1@10/25/50=0.30/0.28/0.23

## 構成
- seed=456 epochs=50 lr=0.0005 stages=2 layers=8 f_maps=64
- server=philip / eval recipe=online_causal+jaccard_strict (PHASE_EVAL_PROTOCOL)
