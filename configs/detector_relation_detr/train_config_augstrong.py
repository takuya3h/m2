...
output_dir = os.environ.get(
    "RELDETR_OUTPUT_DIR",
    "/home/ubuntu/slocal/m2/experiments/detector_improve/augstrong_seed42",
)
...
train_dataset = CocoDetection(
    ...
    transforms=presets.strong_album,  # <CHANGED Method A> S0 default(detr) → 強アグメント（同解像度・aug強度のみ1軸変更）
    train=True,
)
